            ...
            <table class="table datatable table-hover">
                ...
                @foreach ($bantuan as $data)
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <a class="col btn btn-success btn-sm" href="pengajuanBantuan_approve/{{$data->id}}" role="button">
                                    <i class="fas fa-check"></i>
                                </a>
                                <a class="col btn btn-danger btn-sm" href="pengajuanBantuan_rejected/{{$data->id}}" role="button">
            ...
            <table class="table datatable table-hover">
                ...
                @foreach ($history as $data)
                    <tr>
                        ...
                        @endphp
                        <td>
                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#history{{$data->id}}">
                                <i class="fas fa-eye"></i>
                            </button>
                        </td>
                    </tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="ratio ratio-16x9">
                        <iframe class="embed-responsive-item" src="assets/proposalBantuan/{{$data->berkas}}" allowfullscreen></iframe>
                    </div>
                </div>
