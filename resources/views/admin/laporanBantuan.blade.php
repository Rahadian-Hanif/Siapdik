            ...
            <table class="table datatable table-hover">
                ...
                @foreach ($laporan as $data)
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <a class="col btn btn-success btn-sm" href="laporanBantuan_approve/{{$data->id}}" role="button">
                                    <i class="fas fa-check"></i>
                                </a>
                                <a class="col btn btn-danger btn-sm" href="laporanBantuan_rejected/{{$data->id}}" role="button">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="ratio ratio-16x9">
                        <iframe class="embed-responsive-item" src="assets/laporanBantuan/{{$data->berkas}}" allowfullscreen></iframe>
                    </div>
                </div>
