...
<!-- Modal -->
<form action="pengajuanBantuan_upload" method="POST" enctype="multipart/form-data">
@csrf
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            ...
            <div class="modal-body">        
                <div id="message"></div>                
                    ...
                    <div class="mt-3">
                        <select name="jenis" class="form-select shadow" aria-label="Default select example" required>
...
<div class="modal fade" id="prosedur" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog  modal-xl">
        ...
        <div class="modal-body">
            <div class="ratio ratio-16x9">
                <iframe src="assets/prosedur/proposal pengajuan APE.pdf" allowfullscreen></iframe>
            </div>
        </div>
        <div class="modal-footer">
