...
<!-- Modal -->
<form action="laporanBantuan_upload" method="POST" enctype="multipart/form-data">
@csrf
...
<div class="modal fade" id="prosedur" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog  modal-xl">
        ...
        <div class="modal-body">
            <div class="ratio ratio-16x9">
                <iframe src="assets/prosedur/laporan penggunaan BOP.pdf" allowfullscreen></iframe>
            </div>
        </div>
        <div class="modal-footer">
